...
export class KeyboardComponent {
    ...
    renderKeyboard() {
        ...
        // let synthTrigger = undefined;
        // let synthKeyValue = undefined;
        ...
        this.render = body.insertBefore(this._keyboardComponentElemContainer, script);
        ...
        this.generateKeyboardElems(synthTriggerParentDiv, this.synthTrigger, this.synthKeyValue);
    ...
    generateKeyboardElems(synthTriggerParentDiv, synthTrigger, synthKeyValue) {
        ...
        for (let i = 0; i <= keys; i++) {
            ...
            if (!this.keyLetterDictionary || typeof this.keyLetterDictionary[i].musicNote !== 'string') {
                console.error(`keyLetterDictionary does not exist and is ${this.keyLetterDictionary}`);
                return false;
            }

            //create dataset using keyLetterDictionary
            synthKeyValue = synthTrigger.dataset.keyLetterDictionary = this.keyLetterDictionary[i].musicNote;
    ...
    createCustomClickEventListener(synthKeyValue, synthTrigger, customClickcEventDetailMusicNote, synthTriggerElemId) {
    ...
    addEventListenersToSynthKeyElems(synthTrigger, synthKeyValue) {
        ...
        synthTrigger.addEventListener('customClick', (e) => {
            ...
            this.createCustomClickEventListener(synthKeyValue, synthTrigger, customClickcEventDetailMusicNote, synthTriggerElemId);
        });
    }
            ...
            if(this.keyEnabledArray[e.keyCode]) {
                ...
                this.keyLetterDictionary.forEach((letterKey) => {
                    ...
                    if (letterKey.keyboardLetter.indexOf(e.key) > -1) {
                        ...
                        const btnElemIdEventEmitter = synthTriggerParentDiv.childNodes[letterKey.btnElemId];
    ...
    listenForKeyUpEvents(synthTriggerParentDiv) {
        document.addEventListener('keyup', (e) => {
            ...
            this.keyLetterDictionary.forEach((letterKey) => {
                ...
                if (letterKey.keyboardLetter.indexOf(e.key) > -1) {
                    // finds all btn elements and maps them to btnElemId of keyLetterDictionary
                    synthTriggerParentDiv.childNodes[letterKey.btnElemId].classList.remove('active');
                }
            });
        });
    }
