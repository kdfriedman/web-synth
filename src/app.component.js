...
import { keyLetterDictionary, waveFormTypes, envelopeTemplate } from './const.js';
...
class AppComponent {
    ...
    bootstrapComponents() {
        ...
        const envelope = new EnvelopeComponent(renderOptions);
        envelope.renderEnvelope();

        //getter returns keyboard component html container to use as parent element
        controlBoard.retrieveHtmlContainerElem.children[0].children[0].children[0]
        .appendChild(envelope.retrieveHtmlContainerElem);
    }

    convertSVGElementsOnLoad() {
        this.library.add(this.fas); 
        this.dom.i2svg()
        .then(svgElemLoaded => console.log('svgs done'));
    }
}
